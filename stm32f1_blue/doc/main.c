			...
			if(p_Fifo1->rct){
				...
				switch (swh)	{
					...
					do{
						...
						if(STCLK_MS*200 < (trg0 - SysTick->VAL)){	
							trg0  = SysTick->VAL;	
							...
							int2str(uv.UVA ,tbuf,4,0);		//ssd1306_num24(0, 0,tbuf);
							int2str(uv.UVB ,tbuf,4,0);		//ssd1306_num24(64,0,tbuf);
							int2str(uv.UVI ,tbuf,5,4);		//ssd1306_num24(0,4,tbuf);
