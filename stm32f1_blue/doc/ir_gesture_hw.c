...
int ir_gesture_init( uint8_t address )
{
    ...
    temp = DEFAULT_ATIME;         ir_gesture_i2c_hal_write( APDS9960_ATIME, &temp, 1 );
    temp = DEFAULT_WTIME;         ir_gesture_i2c_hal_write( APDS9960_WTIME, &temp, 1 );
    temp = DEFAULT_PROX_PPULSE;   ir_gesture_i2c_hal_write( APDS9960_PPULSE, &temp, 1 );
    temp = DEFAULT_POFFSET_UR;    ir_gesture_i2c_hal_write( APDS9960_POFFSET_UR, &temp, 1 );
    temp = DEFAULT_POFFSET_DL;    ir_gesture_i2c_hal_write( APDS9960_POFFSET_DL, &temp, 1 );
    temp = DEFAULT_CONFIG1;       ir_gesture_i2c_hal_write( APDS9960_CONFIG1, &temp, 1 );
    ...
    temp = DEFAULT_PERS;    ir_gesture_i2c_hal_write( APDS9960_PERS, &temp, 1 );
    temp = DEFAULT_CONFIG2;    ir_gesture_i2c_hal_write( APDS9960_CONFIG2, &temp, 1 );
    temp = DEFAULT_CONFIG3;    ir_gesture_i2c_hal_write( APDS9960_CONFIG3, &temp, 1 );

    /* Set default values for gesture sense registers */
    ir_gesture_set_enter_thresh( DEFAULT_GPENTH );
    ir_gesture_set_exit_thresh( DEFAULT_GEXTH );
    temp = DEFAULT_GCONF1;    ir_gesture_i2c_hal_write( APDS9960_GCONF1, &temp, 1 );
    ...
    temp = DEFAULT_GOFFSET;   ir_gesture_i2c_hal_write( APDS9960_GOFFSET_U, &temp, 1 );
    temp = DEFAULT_GOFFSET;   ir_gesture_i2c_hal_write( APDS9960_GOFFSET_D, &temp, 1 );
    temp = DEFAULT_GOFFSET;   ir_gesture_i2c_hal_write( APDS9960_GOFFSET_L, &temp, 1 );
    temp = DEFAULT_GOFFSET;   ir_gesture_i2c_hal_write( APDS9960_GOFFSET_R, &temp, 1 );
    temp = DEFAULT_GPULSE;    ir_gesture_i2c_hal_write( APDS9960_GPULSE, &temp, 1 );
    temp = DEFAULT_GCONF3;    ir_gesture_i2c_hal_write( APDS9960_GCONF3, &temp, 1 );
