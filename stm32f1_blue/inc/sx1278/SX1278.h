...
#define SX1278_MAX_PACKET	 64		// default 256
...
#define SX1278_434MHZ			1

static const uint8_t SX1278_Frequency[2][3] = { 
{0x6C,0x80,0x00},//433,75MHz
{0x6c,0x70,0xff} 
		};

#define SX1278_POWER_11DBM		0
#define SX1278_POWER_14DBM		1
#define SX1278_POWER_17DBM		2
#define SX1278_POWER_20DBM		3
...
// Spread Factor (SF) nadajnika i odbiornika musi byc taka sama
#define SX1278_LORA_SF_6		0	// max speed
...
#define SX1278_LORA_SF_12		6 // min speed

// Czêstotliwoœæ nadajnika i odbiornika musi byc taka sama
...
typedef enum _SX1278_STATUS {	SLEEP, STANDBY, TX, RX } SX1278_Status_t;
...
__weak void SX1276Write( uint8_t addr, uint8_t data  );
__weak void SX1276Read ( uint8_t addr, uint8_t *data );
uint8_t SX1278_spi(SX1278_hw_t * hw, u08 byte);
