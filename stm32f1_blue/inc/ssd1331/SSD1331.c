...
#define CS_oled	bitband_t m_BITBAND_PERIPH(&GPIOA->ODR, 3)			// CS
#define DC_oled	bitband_t m_BITBAND_PERIPH(&GPIOA->ODR, 2)			// DC

#define sSCK_oled  bitband_t m_BITBAND_PERIPH(&GPIOA->ODR, 1) 	// D0
#define sMOSI_oled bitband_t m_BITBAND_PERIPH(&GPIOA->ODR, 0)  	// D1
...
void SSD1331_init(void)
{
	...
	GPIOA->CRL = (GPIOA->CRL & 0xffff0000) | 0x00001111;	// 
