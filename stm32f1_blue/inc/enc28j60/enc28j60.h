...
// Bank 3 registers
#define MAADR0           (0x01|0x60|0x80) // 0xe1
#define MAADR1           (0x00|0x60|0x80)	// 0xe0
...
//#define		GPIO_Pin_4				4
//#define 	ENC28J60_CS	 			(1<<GPIO_Pin_4)
//#define 	ENC28J60_CSL()		GPIOC->BRR 	= ENC28J60_CS;
//#define 	ENC28J60_CSH()		GPIOC->BSRR = ENC28J60_CS;
#define 	ENC28J60_RES		bitband_t m_BITBAND_PERIPH(&GPIOE->ODR, 1)
#define 	ENC28J60_CS			bitband_t m_BITBAND_PERIPH(&GPIOC->ODR, 4)
#define 	ENC28J60_CSL()	ENC28J60_CS = 0
#define 	ENC28J60_CSH()	ENC28J60_CS = 1
...
extern uint16_t enc28j60PhyRead(u08 address);
