...
// input combinations
#define  GPIO_IN_ANALOG		m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_IN_value, GPIO_CRx_CNF_IN_ANALOG_value)
#define  GPIO_IN_FLOATING	m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_IN_value, GPIO_CRx_CNF_IN_FLOATING_value)
#define  GPIO_IN_PULL_UD	m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_IN_value, GPIO_CRx_CNF_IN_PULL_U_D_value)

// push-pull normal output combinations
#define  GPIO_OUT_PP_2M		m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_OUT_2M_value, GPIO_CRx_CNF_OUT_PP_value)
#define  GPIO_OUT_PP_10M	m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_OUT_10M_value, GPIO_CRx_CNF_OUT_PP_value)
#define  GPIO_OUT_PP_50M	m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_OUT_50M_value, GPIO_CRx_CNF_OUT_PP_value)

// open-drain normal output combinations
#define  GPIO_OUT_OD_2M		m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_OUT_2M_value, GPIO_CRx_CNF_OUT_OD_value)
#define  GPIO_OUT_OD_10M	m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_OUT_10M_value, GPIO_CRx_CNF_OUT_OD_value)
#define  GPIO_OUT_OD_50M	m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_OUT_50M_value, GPIO_CRx_CNF_OUT_OD_value)

// push-pull alternate output combinations
#define  GPIO_ALT_PP_2M		m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_OUT_2M_value, GPIO_CRx_CNF_ALT_PP_value)
#define  GPIO_ALT_PP_10M	m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_OUT_10M_value, GPIO_CRx_CNF_ALT_PP_value)
#define  GPIO_ALT_PP_50M	m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_OUT_50M_value, GPIO_CRx_CNF_ALT_PP_value)

// open-drain alternate output combinations
#define  GPIO_ALT_OD_2M		m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_OUT_2M_value, GPIO_CRx_CNF_ALT_OD_value)
#define  GPIO_ALT_OD_10M	m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_OUT_10M_value, GPIO_CRx_CNF_ALT_OD_value)
#define  GPIO_ALT_OD_50M	m_GPIO_MODE_CNF_value(GPIO_CRx_MODE_OUT_50M_value, GPIO_CRx_CNF_ALT_OD_value)
